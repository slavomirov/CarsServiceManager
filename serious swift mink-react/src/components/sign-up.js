  ...
  return (
    <div className="sign-up-container1">
      <img
        alt={props.image1Alt}
        src={props.image1Src}
        className="sign-up-sign-up-image thq-img-ratio-16-9"
      />
      <div className="sign-up-container2"></div>
      <div className="sign-up-max-width thq-section-max-width">
        <div className="sign-up-form1 thq-section-padding">
          ...
          <div className="sign-up-container3">
            <button className="sign-up-button1 thq-button-outline">
              <svg
          ...
          <span className="sign-up-text15 thq-body-small">
            {props.content1 ?? (
              <Fragment>
          ...
          <button type="submit" className="sign-up-button3 thq-button-filled">
            <span className="sign-up-text19 thq-body-small">
              {props.action1 ?? (
                <Fragment>
