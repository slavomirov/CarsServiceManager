        ...
        <div className="sign-up1-form-root thq-section-padding">
          <div className="sign-up1-form1">
                ...
                {props.heading1 ?? (
                  <Fragment>
                    <span className="sign-up1-text25">
                      Sign Up for Our Car Service Management Platform
                    </span>
                  </Fragment>
                )}
              </h2>
            ...
            <form className="sign-up1-form2">
              <div className="sign-up1-email">
                ...
                <input
                  ...
                  className="sign-up1-textinput1 thq-body-large thq-input"
                />
              </div>
              <div className="sign-up1-username">
                ...
                <input
                  ...
                  className="sign-up1-textinput2 thq-body-large thq-input"
                />
              </div>
              <div className="sign-up1-password">
                <div className="sign-up1-textfield">
                  ...
                  <input
                    ...
                    className="sign-up1-textinput3 thq-body-large thq-input"
                  />
                </div>
                ...
                {props.content1 ?? (
                  <Fragment>
                    <span className="sign-up1-text27">
                      Join our platform to streamline your car service
                      appointments and scheduling. Get started today!
                    </span>
                  </Fragment>
                )}
              </label>
            ...
            <button type="submit" className="thq-button-filled sign-up1-button">
              <span className="sign-up1-text23 thq-body-small">
                {props.action1 ?? (
                  <Fragment>
                    <span className="sign-up1-text26">Create Account</span>
                  </Fragment>
                )}
              </span>
            </button>
...
SignUp1.defaultProps = {
  image1Src:
    'https://images.unsplash.com/photo-1527454743534-ba93f2148eb0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1Mzg4ODYzN3w&ixlib=rb-4.1.0&q=80&w=1080',
  heading1: undefined,
  action1: undefined,
  content1: undefined,
  image1Alt: 'Car Service Management Platform Sign Up',
}
