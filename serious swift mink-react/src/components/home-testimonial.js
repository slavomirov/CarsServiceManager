  ...
  return (
    <div className="thq-section-padding">
      <div className="home-testimonial-max-width thq-section-max-width">
        <div className="home-testimonial-container10">
          <h2 className="thq-heading-2">
            {props.heading1 ?? (
              <Fragment>
                <span className="home-testimonial-text27">Testimonials</span>
              </Fragment>
            )}
          </h2>
          <span className="home-testimonial-text11 thq-body-small">
            {props.content1 ?? (
              <Fragment>
                <span className="home-testimonial-text25">
        ...
        <div className="thq-grid-2">
          <div className="thq-animated-card-bg-2">
            <div className="thq-animated-card-bg-1">
              ...
              >
                <div className="home-testimonial-container12">
                  <img
                    alt={props.author1Alt}
                    src={props.author1Src}
                    className="home-testimonial-image1"
                  />
                  <div className="home-testimonial-container13">
                    <strong className="thq-body-large">
                      {props.author1Name ?? (
                        <Fragment>
                          <span className="home-testimonial-text33">
                            John Doe
                          </span>
                        </Fragment>
                      )}
                    ...
                    <span className="thq-body-small">
                      {props.author1Position ?? (
                        <Fragment>
                          <span className="home-testimonial-text36">
                ...
                <span className="home-testimonial-text14 thq-body-small">
                  {props.review1 ?? (
                    <Fragment>
                      <span className="home-testimonial-text28">
          ...
          <div className="thq-animated-card-bg-2">
            <div className="thq-animated-card-bg-1">
              ...
              >
                <div className="home-testimonial-container14">
                  <img
                    alt={props.author2Alt}
                    src={props.author2Src}
                    className="home-testimonial-image2"
                  />
                  <div className="home-testimonial-container15">
                    <strong className="thq-body-large">
                      {props.author2Name ?? (
                        <Fragment>
                          <span className="home-testimonial-text30">
                            Jane Smith
                          </span>
                        </Fragment>
                      )}
                    ...
                    <span className="thq-body-small">
                      {props.author2Position ?? (
                        <Fragment>
                          <span className="home-testimonial-text35">
                            Service Coordinator
                          </span>
                        </Fragment>
                      )}
                ...
                <span className="home-testimonial-text17 thq-body-small">
                  {props.review2 ?? (
                    <Fragment>
                      <span className="home-testimonial-text32">
          ...
          <div className="thq-animated-card-bg-2">
            <div className="thq-animated-card-bg-1">
              ...
              >
                <div className="home-testimonial-container16">
                  <img
                    alt={props.author3Alt}
                    src={props.author3Src}
                    className="home-testimonial-image3"
                  />
                  <div className="home-testimonial-container17">
                    <strong className="thq-body-large">
                      {props.author3Name ?? (
                        <Fragment>
                          <span className="home-testimonial-text31">
                            Michael Johnson
                          </span>
                        </Fragment>
                      )}
                    ...
                    <span className="thq-body-small">
                      {props.author3Position ?? (
                        <Fragment>
                          <span className="home-testimonial-text26">
                            Mechanic Assistant
                          </span>
                        </Fragment>
                      )}
                ...
                <span className="home-testimonial-text20 thq-body-small">
                  {props.review3 ?? (
                    <Fragment>
                      <span className="home-testimonial-text34">
          ...
          <div className="thq-animated-card-bg-2">
            <div className="thq-animated-card-bg-1">
              <div
                data-animated="true"
                className="thq-card home-testimonial-card4"
              >
                <div className="home-testimonial-container18">
                  <img
                    alt={props.author4Alt}
                    src={props.author4Src}
                    className="home-testimonial-image4"
                  />
                  <div className="home-testimonial-container19">
                    <strong className="thq-body-large">
                      {props.author4Name ?? (
                        <Fragment>
                          <span className="home-testimonial-text24">
                            Sarah Williams
                          </span>
                        </Fragment>
                      )}
                    ...
                    <span className="thq-body-small">
                      {props.author4Position ?? (
                        <Fragment>
                          <span className="home-testimonial-text37">
                            Operations Manager
                          </span>
                        </Fragment>
                      )}
                ...
                <span className="home-testimonial-text23 thq-body-small">
                  {props.review4 ?? (
                    <Fragment>
                      <span className="home-testimonial-text29">
